...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # for each item in an array it initializes a value, uses that value in the block operations, and stores the result to apply to next iteration in the block operation.
  end
