...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # if there is a nonmatching character before or after the wildcard
  end
  ...
  #
  # Why?
  # they match as many occurrences as possible for the overall match to be found
  ...
  # | is used more for word groupings / boundaries
